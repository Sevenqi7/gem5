...
# Functional-validation oriented setup:
# use the atomic CPU model and atomic memory mode to speed up software checks.
...
print("Instantiating the Cheshire SoC functional-validation simulation...")
m5.instantiate()
